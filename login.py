...
bgImage=PhotoImage(file="pictures/bg.png")
bgLabel=Label(root,image=bgImage)
bgLabel.place(x=0,y=0)

logoFrame=Frame(root,bg="White")
logoFrame.place(x=400,y=250)
logoImage=PhotoImage(file="pictures/logo.png")
logoLabel=Label(logoFrame,image=logoImage,justify='center')
logoLabel.grid(row=0,column=0,columnspan=2,pady=10)

userImage=PhotoImage(file="pictures/students-cap.png")
passImage=PhotoImage(file="pictures/padlock.png")
