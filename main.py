...
studentImage=PhotoImage(file="pictures/university.png")
...
studentTable=ttk.Treeview(rightFrame,columns=("ID","Name","Mobile Number","Email","Address","Gender","D.O.B","Added date","Added time"),xscrollcommand=scrollbarX.set)
